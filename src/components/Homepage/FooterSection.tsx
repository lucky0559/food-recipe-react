...
export const FooterSection = () => {
  return (
    <div className="my-8 px-10 flex flex-col lg:flex-row justify-between">
      <div>
        <span className="font-bold inline-block mb-2 text-sm md:text-lg lg:text-xl">
          Contact
        </span>
      ...
      <div className="mt-3 lg:mt-0">
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-xs md:text-sm lg:text-lg">Instagram</span>
        </div>
        <div className="flex items-center mb-2">
          <X size={20} color="red" className="mr-2" />
          <span className="text-xs md:text-sm lg:text-lg">X</span>
        </div>
      </div>
    </div>
  );
